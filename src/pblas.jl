...
function pdgemm!(transa::Char, transb::Char, m::Integer, n::Integer, k::Integer,
        alpha::Float64, A::Matrix{Float64}, ia::Integer, ja::Integer, desca::Vector{Cint},
        B::Matrix{Float64}, ib::Integer, jb::Integer, descb::Vector{Cint}, beta::Float64,
        C::Matrix{Float64}, ic::Integer, jc::Integer, descc::Vector{Cint})
...
function pdtrmm!(side::Char, uplo::Char, transa::Char, diag::Char, m::Integer, n::Integer,
    alpha::Float64, A::Matrix{Float64}, ia::Integer, ja::Integer, desca::Vector{Cint},
    B::Matrix{Float64}, ib::Integer, jb::Integer, descb::Vector{Cint})
